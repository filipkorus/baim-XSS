...
npm run dev
```
Jeśli wszystko przebiegło prawidłowo serwer HTTP powinien działać pod adresem http://localhost:9001.
...
Aby przetestować działanie wpisz w pasek URL dowolny parametr żądania zawierający HTML (np `http://localhost:9001/?param1=<h1>hello</h1>`). W tabeli **po prawej stronie (rendered server-side)** powinien się wyświetlić tekst `<h1>hello</h1>` zamiast <h1 style="margin-top:-30px;">hello</h1>
...
Aby przetestować działanie wpisz w pasek URL dowolny parametr żądania zawierający HTML (np `http://localhost:9001/?param1=<h1>hello</h1>`) w tabelce po lewej stronie powinien się wyświetlić tekst `<h1>hello</h1>` zamiast <h1 style="margin-top:-30px;">hello</h1>
